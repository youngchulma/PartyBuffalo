...
namespace Party_Buffalo.Forms
{
    public partial class DeviceSelector : Form
    {
        ...
        List<ParrotLibs.Drive> mDriveList = null;
        ...
        private void b_ConfirmDrive_Click(object sender, EventArgs e)
        {
            if (mMain != null)
            {
                ...
                mMain.Drive = (ParrotLibs.Drive)DriveList.FocusedItem.Tag;
            }

            SelectedDrive = (ParrotLibs.Drive)DriveList.FocusedItem.Tag;
            foreach (ListViewItem sDrive in DriveList.Items)
            {
                if (sDrive != DriveList.FocusedItem)
                {
                    ((ParrotLibs.Drive)sDrive.Tag).Close();
                }
            }
        }
        ...
        public ParrotLibs.Drive SelectedDrive
        {
            get;
            private set;
        }
