...
namespace ParrotLibs
{
    static public class VariousFunctions
    {
        ...
        static public string[] KnownEquivilent =
                {
                    "Arcade 游戏","人像","Cache 文件","Community Game","试玩游戏",
                    "玩家照片","Game Title","Game Trailer","游戏电影","已安装的游戏",
                    "安装程序","IPTV 暂停的缓存","License Store","卖场内容","电影",
                    "音乐电视","Podcast 录像","玩家记录","Publisher","已保存的游戏",
                    "储存下载","主题","电视","录像","Viral Video",
                    "Xbox 下载","Xbox 一代游戏","Xbox 已保存的游戏","已安装的 360 游戏","Xbox 游戏",
                    "XNA", "Xbox 360 Dashboard", "GOD 游戏包","Storage Pack"
                };
