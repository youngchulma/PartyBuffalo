...
namespace Party_Buffalo.Forms
{
    public partial class CustomBackup : Form
    {
        public CustomBackup()
        {
            ...
            {
                ListViewItem sListItem = new ListViewItem(CLKsFATXLib.VariousFunctions.KnownEquivilent[i] + " (" + CLKsFATXLib.VariousFunctions.Known[i] + ")");
                sListItem.BackColor = Color.White;
                sListItem.UseItemStyleForSubItems = true;
                sListItem.Tag = CLKsFATXLib.VariousFunctions.Known[i];
